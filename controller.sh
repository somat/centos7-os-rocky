...
echo "=== Install and Setup OpenStack on Controller Node ==="

yum -y update

# == Define variable ==
CONTROLLER_PROVIDER_ADDR=172.16.18.161
CONTROLLER_PROVIDER_PREFIX=21
CONTROLLER_PROVIDER_INTERFACE=enp0s3
CONTROLLER_PROVIDER_GATEWAY=172.16.31.252
...
DEFROUTE=yes
ONBOOT=yes
IPADDR=$CONTROLLER_PROVIDER_ADDR
PREFIX=$CONTROLLER_PROVIDER_PREFIX
GATEWAY=$CONTROLLER_PROVIDER_GATEWAY
DEVICE=br-ex
NAME=br-ex
DEVICETYPE=ovs
OVSBOOTPROTO=none
